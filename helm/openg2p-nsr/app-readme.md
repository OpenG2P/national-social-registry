# OpenG2P National Social Registry

A ready-to-install **National Social Registry** built on the OpenG2P registry platform.

This package is a thin overlay over the shared **openg2p-registry** chart: it adds
the NSR domain (Individual and Household registers, their sub-registers, seed
metadata and DCI templates) via the NSR-built images, and reuses the platform's
